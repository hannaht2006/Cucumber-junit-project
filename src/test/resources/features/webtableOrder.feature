Feature: Web table user order feature
  ...
  Scenario Outline:
    ...
    Examples: Famous male scientist
      ...
      | MoneyCog    | 3        | Archimedes        | 221B Baker Street | London | England | 50505   | visa     | 1111222233334444 | 12/23      | Archimedes        |
      | Familybea   | 1        | Carl Linnaeus     | 221B Baker Street | London | England | 50505   | visa     | 1111222233334444 | 12/23      | Carl Linnaeus     |
      | Screenable  | 2        | Ernest Rutherford | 221B Baker Street | London | England | 50505   | visa     | 1111222233334444 | 12/23      | Ernest Rutherford |